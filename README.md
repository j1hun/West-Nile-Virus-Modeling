...
$
\text{MIR} = 1000 \times \frac{\text{num positive traps}}{\text{num mosquitos tested}}
$
...
<img src="https://render.githubusercontent.com/render/math?{\text{MIR}_t, \text{MIR}_{t+1}, \text{MIR}_{t+2}}>
